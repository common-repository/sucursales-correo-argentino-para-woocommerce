<?php
  ...
  add_action('wp_ajax_get_sucursales_ca_free', 'get_sucursales_ca_free', 1);
  add_action('wp_ajax_nopriv_get_sucursales_ca_free', 'get_sucursales_ca_free', 1);

  add_action('wp_ajax_get_localidades_ca_free', 'get_localidades_ca_free', 1);
  add_action('wp_ajax_nopriv_get_localidades_ca_free', 'get_localidades_ca_free', 1);

  function get_localidades_ca_free(){
  ...
  function get_sucursales_ca_free() {
    global $wp_session;
        ...
        jQuery('#order_sucursal_main_ca').insertAfter( jQuery( '.woocommerce-checkout-review-order-table' ) );
            ...
            jQuery('#billing_state').change(function () {  
              ...
              jQuery.ajax({
                ...
                data: {
                  action: 'get_localidades_ca_free',
                  state: state,
                },
